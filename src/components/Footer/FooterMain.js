    ...
    return (
        <footer className="relative bg-gradient-to-br from-gray-900 to-gray-800 text-white overflow-hidden">
            ...
            <div className="relative max-w-7xl mx-auto px-6 py-16 sm:py-20 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-12">
                    ...
                    <div className="group">
                        ...
                        <div className="flex space-x-4">
                            <Link href="#" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-blue-500 hover:shadow-lg hover:shadow-blue-500/30 transition-all duration-300">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            {['Home', 'Projects', 'Services', 'Blog'].map((item) => (
                                <li key={item}>
                                    <Link href="#" className="text-gray-300 hover:text-white hover:pl-2 transition-all duration-300 flex items-center">
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start">
                                ...
                                <div className="ml-3">
                                    ...
                                    <a href="mailto:manueljosedala@hotmail.com" className="text-white hover:text-blue-400 transition">baribhara@hotmail.com</a>
                                </div>
                            </li>
                            <li className="flex items-start">
                                <div className="flex-shrink-0 mt-1">
                    ...
                    <div>
                        ...
                        <form className="mt-4">
                            <div className="relative">
                                <input type="email" placeholder="Your email" className="w-full bg-gray-800 border border-gray-200 border border-gray-200-gray-700 rounded-lg py-3 px-4 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border border-gray-200-transparent placeholder-gray-500 text-white" />
                ...
                {/* Bottom section */}
                <div className="mt-16 pt-8 border border-gray-200-t border border-gray-200-gray-800 flex flex-col md:flex-row justify-between items-center">
                    <p className="text-gray-400 text-sm mb-4 md:mb-0">
                        &copy; <span className="text-blue-400">2025</span> Baribhara. All rights reserved.
                    </p>
