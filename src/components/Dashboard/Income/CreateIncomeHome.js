...
const CreateIncomeHome = () => {
    ...
    useEffect(() => {
        if (Array.isArray(incomeOptions)) {
            const formattedIncomes = incomeOptions.map((income) => ({
                value: income.value,
                label: `${income.label} (${income.bn_name})`,
            }));
        ...
        <div className="sm:p-5 p-3 sm:ml-64 dark:bg-gray-900">
            <div className="flex sm:flex-row flex-col sm:justify-between sm:items-center pb-5 mt-16">
                <div className="sm:flex block gap-5 items-center text-priTextColor dark:text-zinc-200 pb-2 sm:pb-0 sm:w-[50%]">
                    <p className="sm:text-left text-center text-2xl font-bold">Add income</p>
                </div>
            </div>
                ...
                <div className="flex sm:flex-col flex-col items-center gap-3 pt-3 w-full">
                    <div className="flex sm:flex-row flex-col gap-3 w-full">
                        ...
                        <div className="w-full">
                            ...
                            <SelectOptionComponent options={accountTypes} placeholder="Select account type" menuPlacement="bottom"
                            // onChange={(e) => console.log(e)}
                            />
                        </div>
                        <div className="w-full">
                            <p className="text-priColor dark:text-purple-300 text-base">Payment method</p>
                            <SelectOptionComponent options={paymentMethod} placeholder="Select payment method" menuPlacement="bottom"
                            // onChange={(e) => console.log(e)}
                            />
                        </div>
                        <div className="w-full">
                            <p className="text-priColor dark:text-purple-300 text-base">Income type <span className='text-danger'>*</span></p>
                            <SelectOptionComponent options={incomes} placeholder="Select income type" menuPlacement="bottom"
                            // onChange={(e) => console.log(e)}
                            />
                        </div>
                    </div>
...
export default CreateIncomeHome;